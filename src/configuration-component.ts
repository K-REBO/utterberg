...
export class ConfigurationComponent {
  ...
  constructor() {
    ...
    this.element.innerHTML = `
      ...
      <p>
        Choose the repository utterberg will connect to.
      </p>
      <ol>
        <li>Make sure the repo is public, otherwise your readers will not be able to view the issues/comments.</li>
        <li>Register a Codeberg OAuth App and set the <code>client-id</code> attribute (see docs).</li>
      ...
      <p>
        ...
        <a href="https://codeberg.org/utterberg/utterberg/src/branch/main/CONTRIBUTING.md">Contribute</a> a custom theme.
      </p>
      ...
      comments to appear. Customize the layout using the <code>.utterberg</code> and
      <code>.utterberg-frame</code> selectors.
      </p>
    ...
    this.theme.addEventListener('change', () => {
      ...
      const utterberg = document.querySelector('iframe')!;
      utterberg.contentWindow!.postMessage(message, location.origin);
    });
